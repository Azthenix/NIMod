                    ...
                    switch (q.qType)
                    {
                        ...
                        case QuestType.hunt:
                            ...
                            switch (hroll)
                            {
                                ...
                                //    Item.NewItem(npc.GetSource_GiftOrReward(), npc.Center, ItemID.CopperCoin, ContentSamples.NpcsByNetId[hq.enemyID].extraValue * 5 * 3);
                                //    break;
                                //case 2:
                                ...
                                default:
                                    ...
                                    var itemList = ContentSamples.ItemsByType.Values.Where(item => (item.rare == ItemRarityID.White && item.maxStack == 1));
